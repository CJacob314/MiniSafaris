...
public class MainAdminGUI {
    public MainAdminGUI(Player player, MiniSafaris baseInst){
        ...
        reloadAction.setRunnable(context -> {
            ...
            }).delayTicks(1).name("MiniSafaris - To Reload Without Dropping Item").submit(baseInst);
        ...
        container.addState(
                Page.builder()
                        ...
                        .putElement(14, new ActionableElement(legAction, ItemStack.builder().
                                ...
                                .build()))
                        //26
                        .putElement(26, new ActionableElement(new Action(container, ActionType.NORMAL, "reloadconfirm"), ItemStack.builder()
        ...
        container.addState(Page.builder()
                ...
                .putElement(2, new ActionableElement(new Action(container, ActionType.BACK, "safaris"), ItemStack.builder()
